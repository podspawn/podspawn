...
var rootCmd = &cobra.Command{
	...
	PersistentPreRunE: func(cmd *cobra.Command, args []string) error {
		...
		if err != nil {
			if cmd.Name() == "help" || cmd.Name() == "completion" || cmd.Name() == "connect" || cmd.Name() == "setup" || cmd.Name() == "server-setup" || cmd.Name() == "version" || cmd.Name() == "list" || cmd.Name() == "stop" || cmd.Name() == "cleanup" || !cmd.HasParent() {
